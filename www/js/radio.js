...
export default async () => {
    if (window.location.pathname.endsWith('/pages/radio.html')) {
        try {
            ...
            async function displayRadioItems(data) {
                ...
                for (let item of data) {
                    ...
                    radioLogo.width = 50;
                    radioLogo.height = 50;
                    let radio_quran_play = document.createElement("i");
                    ...
                    radio_quran_play.className = "ph ph-play radio_quran_play";
                    ...
                    radio_quran_play.addEventListener("click", async () => {
                        try {
                            ...
                            if (audio.paused) {
                                radio_quran_play.className = "ph ph-circle-notch ph-spin radio_quran_play";
                                isMediaPlayStorage(false);
                                isPausedStorage(true);
            ...
            function setPlayIcon(audioElement) {
                ...
                if (playButton) {
                    playButton.className = "ph ph-play radio_quran_play";
                }
            }
            ...
            function setStopIcon(audioElement) {
                ...
                if (stopButton) {
                    stopButton.className = "ph ph-stop radio_quran_play playing";
                }
            }
